...
public class FenetreMenuMaster extends JFrame{
	...
	public FenetreMenuMaster() {
		...
		contentPaneMenu.setBackground(Color.getHSBColor(0.504f, 0.54f, 0.55f));
	...
	private void initMenu() {
		...
		espace2.setPreferredSize(new Dimension(400,10));
		 ...
		 mode1 = new JRadioButton("Mode Challenger");
		    ...
		    espace1.setBackground(Color.getHSBColor(0.504f, 0.54f, 0.55f));
		    ...
		    espaceMaster.setBackground(Color.getHSBColor(0.504f, 0.54f, 0.55f));
